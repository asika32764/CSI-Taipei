...
?>
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-inline" style="margin: 7px 0 0 0;">
	...
	<div class="userdata">
		...
		<div id="form-login-remember" class="form-group checkbox hide">
