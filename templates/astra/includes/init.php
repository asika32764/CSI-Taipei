...
if( Astra::_('jversion.gte30') ){
	...
	$doc->addScript('templates/'.$this->template.'/js/bootstrap3.min.js');

	$doc->addStyleSheet('//netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css');
	$doc->addStyleSheet('templates/'.$this->template.'/css/bootstrap3-adapter.min.css');
