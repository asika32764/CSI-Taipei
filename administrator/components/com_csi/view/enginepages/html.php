...
/**
 * Class EnginepagesHtmlView
 *
 * @since 1.0
 */
class CsiViewEnginepagesHtml extends GridView
{
	/**
	 * Property prefix.
	 *
	...
	public function __construct(Model $model = null, Container $container = null, $config = array(), \SplPriorityQueue $paths = null)
	{
		$config['grid'] = array(
			// Some basic setting
			'option'    => 'com_csi',
			'view_name' => 'enginepage',
			'view_item' => 'enginepage',
			'view_list' => 'enginepages',

			// Column which we allow to drag sort
			'order_column'   => 'enginepage.catid, enginepage.ordering',

			// Table id
			'order_table_id' => 'enginepageList',
