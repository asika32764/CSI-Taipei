...
<!-- LIST TABLE -->
<table id="schoolList" class="table table-striped adminlist">
...
<tr>
	...
	<th width="5%" class="nowrap center">
		<?php echo $grid->sortTitle('JSTATUS', 'school.state'); ?>
	</th>

	<!--TITLE-->
	<th class="center">
		<?php echo $grid->sortTitle('JGLOBAL_TITLE', 'school.title'); ?>
	</th>
	...
	<!--CREATED-->
	<th width="10%" class="center">
		<?php echo $grid->sortTitle('JDATE', 'school.created'); ?>
	</th>
	...
	<th width="1%" class="nowrap center">
		<?php echo $grid->sortTitle('JGRID_HEADING_ID', 'school.id'); ?>
	</th>
</tr>
</thead>
...
<?php foreach ($data->items as $i => $item)
	...
	$grid->setItem($item, $i);
	?>
	<tr class="school-row" sortable-group-id="<?php echo $item->catid; ?>">
		<!-- DRAG SORT -->
