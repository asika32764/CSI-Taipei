...
<div id="csi" class="windwalker histories tablelist row-fluid">
	<form action="<?php echo JURI::getInstance(); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
		...
		<table id="historyList" class="adminlist table table-striped modal-list">
			<thead>
			<tr>
				<!--TITLE-->
				<th class="center">
					<?php echo $grid->sortTitle('JGLOBAL_TITLE', 'history.title'); ?>
				</th>
				...
				<!--CREATED-->
				<th class="center">
					<?php echo $grid->sortTitle('JDATE', 'history.created'); ?>
				</th>
