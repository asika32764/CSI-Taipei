...
<!-- LIST TABLE -->
<table id="notifyList" class="table table-striped adminlist">
...
<tr>
	...
	<th width="5%" class="nowrap center">
		<?php echo $grid->sortTitle('JSTATUS', 'notify.published'); ?>
	</th>

	<!--TITLE-->
	<th class="center">
		<?php echo $grid->sortTitle('JGLOBAL_TITLE', 'notify.title'); ?>
	</th>
	...
	<!--CREATED-->
	<th width="10%" class="center">
		<?php echo $grid->sortTitle('JDATE', 'notify.created'); ?>
	</th>
	...
	<th width="1%" class="nowrap center">
		<?php echo $grid->sortTitle('JGRID_HEADING_ID', 'notify.id'); ?>
	</th>
</tr>
</thead>
...
<?php foreach ($data->items as $i => $item)
	...
	$grid->setItem($item, $i);
	?>
	<tr class="notify-row" sortable-group-id="<?php echo $item->catid; ?>">
		<!-- DRAG SORT -->
		...
		<!--CHECKBOX-->
		<td class="center">
			<?php echo JHtml::_('grid.id', $i, $item->notify_id); ?>
		</td>
